...
<div class="modal fade" id="confirm_modal" role='dialog'>
  ...
  <div id="preloader"></div>
        <footer class="py-5">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 ml-auto text-center mb-5 mb-lg-0">
                        <i class="fas fa-phone fa-2x mb-3 text-muted my-icon"></i>
            ...
            <br>
            <div class="container"><div class="small text-center text-muted "><p class="text-white">
            Copyright © 2021 - <?php echo $_SESSION['system']['name'] ?> | <a href="/" target="_blank">spnh</a>
            </p> </div></div>
        </footer>
