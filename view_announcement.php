...
include 'admin/db_connect.php'; 
 $announcement = $conn->query("SELECT *,u.name from announcements a inner join users u on u.id = a.user_id  where a.id = ".$_GET['id']);
    ...
    <div class="card mb-4">
        ...
        <!-- <hr class="divider"> -->
         <div class="d-flex align-items-center justify-content-center">
             <span class="badge badge-info  px-3 pt-1 pb-1">
