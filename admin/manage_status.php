	...
	<form action="" id="manage-forum">
		...
		<div class="row form-group">
			<div class="col-md-12">
				...
				<input type="text" name="title" class="form-control" value="<?php echo isset($title) ? $title:'' ?>" readonly>
			</div>
		</div>
		<div class="row form-group">
			<div class="col-md-12">
				<label class="control-label">Description</label>
				<textarea name="description" class="text-jqte"><?php echo isset($content) ? $content : '' ?> </textarea>
			</div>
			<div class="col-md-12">
